                    ...
                    <tbody>
                        @forelse($amenities as $a)
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                <td class="py-2 text-gray-800 dark:text-gray-200">{{ $a->id }}</td>
                                <td class="text-gray-800 dark:text-gray-200">{{ $a->name }}</td>
                                <td class="text-right">
                                    <a class="text-blue-600" href="{{ route('amenities.edit', $a) }}">Редактировать</a>

                                    <form class="inline" method="POST" action="{{ route('amenities.destroy', $a) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="py-4 text-center text-gray-500">Нет удобств</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
