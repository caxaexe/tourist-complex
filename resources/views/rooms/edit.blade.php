            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded p-6">
                <form method="POST" action="{{ route('rooms.update', $room) }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input name="number" value="{{ old('number', $room->number) }}" class="border rounded w-full px-3 py-2">
                    ...
                    <div class="flex gap-4">
                        <div class="w-1/2">
                            ...
                            <input name="price_per_night" value="{{ old('price_per_night', $room->price_per_night) }}" class="border rounded w-full px-3 py-2">
                        ...
                        <div class="w-1/2">
                            ...
                            <input name="capacity" value="{{ old('capacity', $room->capacity) }}" class="border rounded w-full px-3 py-2">
                    ...
                    <div>
                        ...
                        <input name="title" value="{{ old('title', $room->title) }}" class="border rounded w-full px-3 py-2">
                    ...
                    <div>
                        ...
                        <textarea name="description" class="border rounded w-full px-3 py-2" rows="4">{{ old('description', $room->description) }}</textarea>
