    ...
    <div class="py-6 max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded p-6">
            ...
            <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-4">
                ...
                <div>
                    <label class="block mb-1">Логин (name)*</label>
                    <input name="name" value="{{ old('name') }}" class="border border-gray-300 dark:border-gray-700 rounded w-full px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    @error('name') <div class="text-red-600">{{ $message }}</div> @enderror
                </div>

                <div>
                    <label class="block mb-1">ФИО</label>
                    <input name="full_name" value="{{ old('full_name') }}" class="border border-gray-300 dark:border-gray-700 rounded w-full px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>

                <div>
                    <label class="block mb-1">Email*</label>
                    <input name="email" value="{{ old('email') }}" class="border border-gray-300 dark:border-gray-700 rounded w-full px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    @error('email') <div class="text-red-600">{{ $message }}</div> @enderror
                </div>

                <div>
                    <label class="block mb-1">Телефон</label>
                    <input name="phone" value="{{ old('phone') }}" class="border border-gray-300 dark:border-gray-700 rounded w-full px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input name="position" value="{{ old('position') }}" class="border border-gray-300 dark:border-gray-700 rounded w-full px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea name="duties" rows="3" class="border border-gray-300 dark:border-gray-700 rounded w-full px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('duties') }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        <label class="block mb-1">Должность</label>
                        <input name="position" value="{{ old('position') }}" class="border rounded w-full px-3 py-2">
                    </div>
                    <div>
                        <label class="block mb-1">Зарплата</label>
                        <input type="number" step="0.01" name="salary" value="{{ old('salary') }}"
                ...
                <div>
                    <label class="block mb-1">Обязанности</label>
                    <textarea name="duties" rows="3" class="border rounded w-full px-3 py-2">{{ old('duties') }}</textarea>
                </div>
