            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Логин (name)*</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">ФИО</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Повтор пароля*</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Должность</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Зарплата</label>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex gap-3">
                            <a href="{{ route('admin.users.index') }}" class="px-4 py-2 border rounded-md text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">Назад</a>
