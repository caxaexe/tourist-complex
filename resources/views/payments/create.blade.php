    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow rounded p-6">
                ...
                @if(!empty($invoice))
                    <div class="mb-4 p-3 bg-gray-100 dark:bg-gray-900/40 rounded text-gray-800 dark:text-gray-200 dark:text-gray-200">
                ...
                <form method="POST" action="{{ route($prefix.'payments.store') }}" class="space-y-4">
                    ...
                    <div>
                        <label class="block mb-1 text-gray-700 dark:text-gray-200 dark:text-gray-200">Сумма *</label>
                    ...
                    <div>
                        <label class="block mb-1 text-gray-700 dark:text-gray-200 dark:text-gray-200">Метод *</label>
                        <select name="method"
                                class="border rounded w-full px-3 py-2 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 dark:text-gray-200 border-gray-200 dark:border-gray-700 dark:border-gray-700">
                    ...
                    <div>
                        <label class="block mb-1 text-gray-700 dark:text-gray-200 dark:text-gray-200">Дата оплаты</label>
                    ...
                    <div>
                        <label class="block mb-1 text-gray-700 dark:text-gray-200 dark:text-gray-200">Комментарий</label>
                        <textarea name="note" rows="3"
                                  class="border rounded w-full px-3 py-2 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 dark:text-gray-200 border-gray-200 dark:border-gray-700 dark:border-gray-700">{{ old('note') }}</textarea>
