        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-white dark:bg-gray-800 shadow rounded p-5">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                        <div class="text-lg font-semibold text-gray-800 dark:text-gray-200">Мои бронирования</div>
                        <div class="text-sm text-gray-500 dark:text-gray-400">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <a href="{{ route('my.bookings.index') }}"
                   class="block bg-white dark:bg-gray-800 shadow rounded p-5 hover:shadow-md transition">
                    <div class="text-sm text-gray-500 dark:text-gray-400">Мои данные</div>
                    <div class="mt-1 text-lg font-semibold text-gray-800 dark:text-gray-200">Список бронирований</div>
                ...
                <a href="{{ route('my.bookings.create') }}"
                   class="block bg-white dark:bg-gray-800 shadow rounded p-5 hover:shadow-md transition">
                    <div class="text-sm text-gray-500 dark:text-gray-400">Новая заявка</div>
                    <div class="mt-1 text-lg font-semibold text-gray-800 dark:text-gray-200">Создать бронирование</div>
                    <div class="mt-2 text-sm text-gray-600 dark:text-gray-300">
                ...
                <a href="{{ route('profile.edit') }}"
                   class="block bg-white dark:bg-gray-800 shadow rounded p-5 hover:shadow-md transition">
                    <div class="text-sm text-gray-500 dark:text-gray-400">Аккаунт</div>
                    <div class="mt-1 text-lg font-semibold text-gray-800 dark:text-gray-200">Профиль</div>
                    <div class="mt-2 text-sm text-gray-600 dark:text-gray-300">
