        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <a href="{{ route('admin.users.index') }}"
                   class="block bg-white dark:bg-gray-800 shadow rounded p-5 hover:shadow-md transition">
                    <div class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400">Доступ</div>
                    <div class="mt-1 text-lg font-semibold text-gray-800 dark:text-gray-200 dark:text-gray-200">Пользователи</div>
                    <div class="mt-2 text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300">
                ...
                <a href="{{ route('admin.audit-logs.index') }}"
                   class="block bg-white dark:bg-gray-800 shadow rounded p-5 hover:shadow-md transition">
                    <div class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400">Контроль</div>
                    <div class="mt-1 text-lg font-semibold text-gray-800 dark:text-gray-200 dark:text-gray-200">Audit Logs</div>
                    <div class="mt-2 text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300">
                ...
                <a href="{{ route('admin.reports.index') }}"
                   class="block bg-white dark:bg-gray-800 shadow rounded p-5 hover:shadow-md transition">
                    <div class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400">Аналитика</div>
                    <div class="mt-1 text-lg font-semibold text-gray-800 dark:text-gray-200 dark:text-gray-200">Отчёты</div>
                    <div class="mt-2 text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300">
