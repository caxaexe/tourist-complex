...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Редактировать клиента #') }}{{ $client->id }}
        </h2>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow rounded p-6">
                ...
                <form method="POST" action="{{ route($prefix.'clients.update', $client) }}" class="space-y-4">
                    @csrf
                    @method('PUT')

                    <div>
                        <label class="block mb-1 text-gray-700 dark:text-gray-200">{{ __('ФИО *') }}</label>
                    ...
                    <div>
                        <label class="block mb-1 text-gray-700 dark:text-gray-200">{{ __('Телефон') }}</label>
                        <input name="phone"
                    ...
                    <div>
                        <label class="block mb-1 text-gray-700 dark:text-gray-200">{{ __('Email') }}</label>
                        <input name="email"
                    ...
                    <div class="flex gap-4">
                        <div class="w-1/2">
                            <label class="block mb-1 text-gray-700 dark:text-gray-200">{{ __('Серия паспорта') }}</label>
                        ...
                        <div class="w-1/2">
                            <label class="block mb-1 text-gray-700 dark:text-gray-200">{{ __('Номер паспорта') }}</label>
                    ...
                    <div>
                        <label class="block mb-1 text-gray-700 dark:text-gray-200">{{ __('Дата рождения') }}</label>
                        <input type="date"
                               name="birth_date"
                    ...
                    <div>
                        <label class="block mb-1 text-gray-700 dark:text-gray-200">{{ __('Адрес') }}</label>
