        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4 flex flex-col sm:flex-row gap-2 sm:items-center">
                <form method="GET" action="{{ route($prefix.'clients.index') }}" class="flex gap-2">
                    ...
                    <button class="px-4 py-2 bg-gray-800 text-white rounded hover:bg-gray-900 dark:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900">Найти</button>
                </form>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="text-left border-b border-gray-200 dark:border-gray-700 dark:border-gray-700">
                            ...
                            <th class="text-gray-700 dark:text-gray-200 dark:text-gray-200">ФИО</th>
                            <th class="text-gray-700 dark:text-gray-200 dark:text-gray-200">Телефон</th>
                            <th class="text-gray-700 dark:text-gray-200 dark:text-gray-200">Email</th>
                    ...
                    <tbody>
                        @forelse($clients as $client)
                            <tr class="border-b border-gray-200 dark:border-gray-700 dark:border-gray-700">
                                <td class="py-2 text-gray-800 dark:text-gray-200 dark:text-gray-200">{{ $client->id }}</td>
                                <td class="text-gray-800 dark:text-gray-200 dark:text-gray-200">{{ $client->full_name }}</td>
                                <td class="text-gray-800 dark:text-gray-200 dark:text-gray-200">{{ $client->phone ?? '—' }}</td>
                                <td class="text-gray-800 dark:text-gray-200 dark:text-gray-200">{{ $client->email ?? '—' }}</td>
