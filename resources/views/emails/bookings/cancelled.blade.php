...
<html>
<head>
    <title>{{ __('Бронирование отменено') }}</title>
</head>
        ...
        <div style="background-color: #030712; padding: 20px; border-radius: 6px; border: 1px solid #1f2937; margin: 20px 0;">
            <ul style="list-style: none; padding: 0; margin: 0;">
                ...
                <li style="margin-top: 10px; padding-top: 10px; border-top: 1px dashed #374151;">
                    <span style="color: #9ca3af;">{{ __('Причина отмены:') }}</span> 
                    <strong style="color: #f87171;">{{ $reason ?? __('Не указана') }}</strong>
                </li>
            </ul>
        </div>

        <p style="color: #9ca3af; font-size: 14px; margin-top: 20px;">
            {{ __('Если произошла ошибка или вы хотите выбрать другие даты для поездки, просто свяжитесь с нами.') }}
        </p>
    </div>
</body>
</html>