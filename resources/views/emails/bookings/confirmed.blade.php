...
<body style="font-family: Arial, sans-serif; background-color: #030712; color: #e5e7eb; padding: 20px; margin: 0;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #111827; padding: 30px; border-radius: 8px; border: 1px solid #1f2937;">
        ...
        <p style="color: #d1d5db; font-size: 15px; line-height: 1.6;">
            Ваша заявка на бронирование в <strong>Castle Noctem</strong> успешно подтверждена.
        </p>
            ...
            <ul style="list-style: none; padding: 0; margin: 0;">
                <li style="margin-bottom: 10px;">
                    ...
                    <strong style="color: #60a5fa;">
                        {{ $booking->room->roomType->name ?? 'Покои Замка' }} (Комната №{{ $booking->room->number ?? '—' }})
                    </strong>
                </li>
                <li style="margin-bottom: 10px;">
                ...
                <li style="margin-top: 10px; padding-top: 10px; border-top: 1px dashed #374151;">
                    <span style="color: #9ca3af;">Сумма к оплате:</span> 
                    <strong style="color: #34d399;">{{ number_format((float)$booking->total, 2, '.', ' ') }} лей</strong>
                </li>
            </ul>
        </div>

        <p style="color: #9ca3af; font-size: 14px; margin-top: 20px;">
            Ждем вас! Если у вас возникнут вопросы по размещению, пожалуйста, свяжитесь с нами.
        </p>
    </div>
</body>
</html>